...
// 5. Initialization/Instantiate Objects
  ...
  VentilatorControl        VentilatorControl(KP_AIR_PIP, KI_AIR_PIP, KD_AIR_PIP, KP_AIR_PEEP, KI_AIR_PEEP, KD_AIR_PEEP,BLOWER_ESC_PIN,ESC_PWM_MIN,ESC_PWM_MAX,EXHALATION_VALVE_SERVO_PIN,EXHALATION_VALVE_PWM_CLOSED,EXHALATION_VALVE_PWM_OPEN,pinBuzzer);  // (Kp, Ki, Kd, Kp, Ki, Kd)
// ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

// ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
void setup(){
...
void loop(){
  ...
  //Serial.println(pressureGaugeAirLine);
    ...
    float Cd = 0.94;
    float roh_air = 1.225;
    //float A1 = 0.000183;                // 1/2 inch venturi
    //float A2 = A1/4;
    //float Cd = 0.94;
    //float roh_air = 1.225;
    
    float flowRateOxy = A1*Cd*(pow(((2/roh_air)*(pressureDifferentialOxyVenturi/15.0)),0.5));
  ...
  */
  ...
  // 4. Ventilator control
    VentilatorControl.setVentilatorMode(PRESSURE_MAX_PIP,PRESSURE_MIN_PEEP,pressureGaugeAirLine,pressureDifferentialAirVenturi,TIME_PEEP_TO_PIP,TIME_INHALATION,TIME_EXHALATION);       // (PIP,PEEP,sensor reading,PEEP to PIP,inhalation duration,exhalation duration)
